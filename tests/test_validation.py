...
if __name__ == "__main__":
    print("=" * 50)
    print("AI-ROS Validation Suite")
    print("=" * 50)
    tests = [test_config, test_exceptions, test_middleware, test_security, test_ai, test_services, test_main_app]
    passed = 0
    failed = 0
    for t in tests:
        try: t(); passed += 1
