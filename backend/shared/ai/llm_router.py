...
class LLMRouter:
    ...
    async def complete(self, messages: list[dict[str, str]], model: str = "gpt-4o", temperature: float = 0.7, max_tokens: int = 4096) -> LLMResponse:
        ...
        return LLMResponse(content="Mock response for development.", model=model, prompt_tokens=100, completion_tokens=50, total_tokens=150, latency_ms=latency, provider="mock")
