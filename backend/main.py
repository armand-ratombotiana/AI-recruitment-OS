...
include_router_safe(app, "apps.referral.main", "router", "/api/v1/referrals", ["Referrals"])
...
include_router_safe(app, "apps.bulk_service.main", "router", "/api/v1/bulk", ["Bulk Operations"])
