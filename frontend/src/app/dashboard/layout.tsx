  ...
  return (
    <NotificationProvider position="top-right" maxNotifications={5}>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-slate-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950">
        ...
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-surface-900 border-r border-gray-200 dark:border-surface-700 transform transition-transform duration-300 ease-out lg:translate-x-0 flex flex-col shadow-sm ${
        ...
        >
          <div className="flex items-center justify-between gap-2 px-5 h-16 border-b border-gray-200 dark:border-surface-700 shrink-0">
            ...
            <button
              onClick={() => setSidebarOpen(false)}
              className="lg:hidden p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-surface-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              ...
              return (
                ...
                >
                  <Icon
                    ...
                    aria-hidden="true"
                  />
                  <span className="flex-1 truncate">{translate(locale, item.key, item.key)}</span>
                  {item.badge && (
                  ...
                  {active && <span className="h-1.5 w-1.5 rounded-full bg-blue-600 dark:bg-brand-400" aria-hidden="true" />}
                </Link>
              );
            })}
          </nav>
          ...
          <div className="p-3 border-t border-gray-100 dark:border-surface-700 shrink-0">
            <div className="rounded-xl bg-gradient-brand p-4 text-white shadow-brand">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <p className="text-xs font-semibold">{translate(locale, 'nav.proTip', 'Pro tip')}</p>
              </div>
        ...
        <div className="lg:ml-64">
          <header className="sticky top-0 z-30 bg-white/80 dark:bg-surface-900/80 backdrop-blur-md border-b border-gray-200 dark:border-surface-700 h-16 flex items-center gap-3 px-4 lg:px-6">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-surface-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
