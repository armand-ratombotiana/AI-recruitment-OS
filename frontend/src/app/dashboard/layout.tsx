...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/interviews', label: 'Interviews', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  { href: '/dashboard/ppe', label: 'PPE', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
  ...
  { href: '/dashboard/ai-copilot', label: 'AI Copilot', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
      ...
      <div className="lg:ml-64">
        <header className="sticky top-0 z-30 bg-white border-b h-16 flex items-center px-4 lg:px-6">
          ...
          <div className="flex-1 mx-4">
            <input type="text" placeholder="Search..." className="w-full max-w-md px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
