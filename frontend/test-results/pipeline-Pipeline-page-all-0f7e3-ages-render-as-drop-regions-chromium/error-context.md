...
- Name: pipeline.spec.ts >> Pipeline page >> all seven pipeline stages render as drop regions
      ...
      - main [ref=e137]:
        - generic [ref=e138]:
          ...
          - generic [ref=e139]:
            - generic [ref=e140]:
              ...
              - button "Show tour" [ref=e144] [cursor=pointer]:
                - img [ref=e145]
            - generic [ref=e148]:
              - generic [ref=e151]: Live · 11:23:58 PM
          ...
          - generic [ref=e160]:
            ...
            - status "Loading" [ref=e167]
      - region "Notifications"
      - button "Open quick actions" [ref=e169] [cursor=pointer]:
        - img [ref=e170]
  - region "Notifications" [ref=e171]:
    - alert [ref=e172]:
      - img [ref=e173]
      - generic [ref=e175]:
        - paragraph [ref=e176]: Reconnecting
        - paragraph [ref=e177]: Restoring real-time updates…
      - button "Dismiss notification" [ref=e178] [cursor=pointer]:
        - img [ref=e179]
  - alert [ref=e182]
```